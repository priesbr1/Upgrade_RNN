...
def plot_hit_info(pulse_charge, pmt_index, true_energies, num_use, logscale=False, gen_filename='path/save_folder/'):
    ...
    if (not num_use or num_use >= len(pulse_charge)) and logscale == False:
        plt.savefig(gen_filename+'dist_hits_energybins_all.png')
    elif not num_use or num_use >= len(pulse_charge):
        plt.savefig(gen_filename+'dist_hits_energybins_ylog_all.png')
    elif logscale == True:
        plt.savefig(gen_filename+'dist_hits_energybins_ylog_'+str(num_use)+'.png')
    else:
        plt.savefig(gen_filename+'dist_hits_energybins_'+str(num_use)+'.png')
    ...
    plt.bar(energy_dist,hit_dist,8)
    if (not num_use or num_use >= len(pulse_charge)) and logscale == False:
        plt.savefig(gen_filename+'dist_hitsperenergy_energybins_all.png')
    elif not num_use or num_use >= len(pulse_charge):
        plt.savefig(gen_filename+'dist_hitsperenergy_energybins_ylog_all.png')
    elif logscale == True:
        plt.savefig(gen_filename+'dist_hitsperenergy_energybins_ylog_'+str(num_use)+'.png')
    else:
        plt.savefig(gen_filename+'dist_hitsperenergy_energybins_'+str(num_use)+'.png')
    ...
    if (not num_use or num_use >= len(pulse_charge)) and logscale == False:
        plt.savefig(gen_filename+'dist_hits_all.png')
    elif not num_use or num_use >= len(pulse_charge):
        plt.savefig(gen_filename+'dist_hits_ylog_all.png')
    elif logscale == True:
        plt.savefig(gen_filename+'dist_hits_ylog_'+str(num_use)+'.png')
    else:
        plt.savefig(gen_filename+'dist_hits_'+str(num_use)+'.png')
    ...
    bar.set_label('Counts')
    if (not num_use or num_use >= len(pulse_charge)) and logscale == False:
        plt.savefig(gen_filename+'dist2D_hits_energy_all.png')
    elif not num_use or num_use >= len(pulse_charge):
        plt.savefig(gen_filename+'dist2D_hits_energy_ylog_all.png')
    elif logscale == True:
        plt.savefig(gen_filename+'dist2D_hits_energy_ylog_'+str(num_use)+'.png')
    else:
        plt.savefig(gen_filename+'dist2D_hits_energy_'+str(num_use)+'.png')
    ...
    if (not num_use or num_use >= len(pmt_index)) and logscale == False:
        plt.savefig(gen_filename+'dist_PMTs_all.png')
    elif not num_use or num_use >= len(pmt_index):
        plt.savefig(gen_filename+'dist_PMTs_ylog_all.png')
    elif logscale == True:
        plt.savefig(gen_filename+'dist_PMTs_ylog_'+str(num_use)+'.png')
    else:
        plt.savefig(gen_filename+'dist_PMTs_'+str(num_use)+'.png')
...
def plot_vertex(x, y, z, num_use, gen_filename='path/save_folder/'):
    ...
    if not num_use or num_use >= len(z):
        plt.savefig(gen_filename+'vertex_positions_all.png')
    else:
        plt.savefig(gen_filename+'vertex_positions_'+str(num_use)+'.png')
